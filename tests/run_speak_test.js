...
console.log('=== ۱۶) سقفِ «یک فایل» از اندازه‌گیری می‌آید، نه از یک ثابت ===');
{
  ...
  const ep = { __speakSegs: [{ h: 'aa:4000', t: 'x' }, { h: 'bb:3297', t: 'y' }] };
  ok('۱۶.۲ شمارِ نویسهٔ گفتنی از امضای بخش‌ها می‌آید', speechChars_(ep) === 7297);
  ...
  speechCalibRecord_({ __speakSegs: [{ h: 'cc:7000', t: 'z' }] }, 34000000, 'قسمت ۲۱');
  ...
  ok('۱۶.۸ اندازه‌گیریِ بیرون از بازهٔ معقول ثبت نمی‌شود',
     speechCalibRecord_({ __speakSegs: [{ h: 'dd:5000', t: 'q' }] }, 2000000, 'خراب') === null);
  delete global.__PROPS[PK.SPEECH_CAL];
}
