...
console.log('\n=== 7. دستورِ گفتارِ کوتاه (پادزهرِ «پرامپت‌خوانی») ===');
{
  ...
  ok('7.5 متنِ بی‌اعراب یادآورِ کوتاهِ تلفظ می‌گیرد', cue.indexOf('«آ»') !== -1);
  ...
  ok('7.6 متنِ اعراب‌دار همان یادآور را هم نمی‌گیرد (متن خودش راهنماست)',
     ttsCue_('آرام', vowelled).indexOf('«آ»') === -1);
