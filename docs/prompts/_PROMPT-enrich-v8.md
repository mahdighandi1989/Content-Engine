> نسخه: 8 — 2026-08-23
> برای نسخهٔ موتور: 5.67
> این فایل «بدنهٔ» دستورِ تسکِ غنی‌سازی است. تسک آن را از درایو می‌خواند.
> به‌روزرسانی = ساختنِ فایلِ تازه با شمارهٔ بالاتر (`_PROMPT-enrich-v9.md`).
> هرگز این فایل را بازنویسی نکنید؛ تاریخچه باید بماند.
>
> تغییرِ نسخهٔ ۸ نسبت به ۷ — فایلِ آرزوها حالا نامِ خودِ صدا را می‌گوید:
> صاحبِ برنامه پرسید «وقتی می‌خواهد افکتی را از اینترنت بگیرد، مگر قبلش
> می‌داند متنِ پادکستِ فردا چیست؟» — و نمی‌دانست. گشتنِ خودکار ۲:۳۰ اجرا
> می‌شود و متنِ قسمت ساعتِ ۷ نوشته می‌شود. بدتر: هیچ‌جا ثبت نمی‌شد که قسمتی
> صدای باران می‌خواست و بانک نداشت.
> از ۵٫۶۷ موتور از مدل می‌پرسد «این قسمت چه صدایی می‌خواهد؟» و جوابِ
> برآورده‌نشده را در `_MUSIC-WISH.json` می‌گذارد با `kind:"افکت"` و نامِ
> فارسیِ صدا (`sound`) و واژه‌های انگلیسیِ جست‌وجو (`en`).
> **این ردیف‌ها مهم‌ترین کارِ تو در بخشِ موسیقی‌اند** — دقیقاً می‌گویند چه چیزی
> لازم است، و pixabay (با راهِ تبدیلِ بخشِ ۹) بهترین منبع برایشان است.
