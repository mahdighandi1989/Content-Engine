...
> به‌روزرسانی = ساختنِ فایلِ تازه با شمارهٔ بالاتر (`_PROMPT-enrich-v4.md`).
> هرگز این فایل را بازنویسی نکنید؛ تاریخچه باید بماند.
>
> تغییرِ نسخهٔ ۳ نسبت به ۲: خطِ «برای نسخهٔ موتور» اضافه شد — موتور از ۵٫۴۸
> با آن می‌سنجد که این دستور از کد عقب نمانده باشد.
