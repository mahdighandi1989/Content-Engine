> نسخه: 17 — 2026-08-29
> برای نسخهٔ موتور: 6.43
> این فایل «بدنهٔ» دستورِ تسکِ غنی‌سازی است. تسک آن را از درایو می‌خواند.
> به‌روزرسانی = ساختنِ فایلِ تازه با شمارهٔ بالاتر (`_PROMPT-enrich-v18.md`).
...
>    ساعت. (دقت کن: تبدیلِ MP3 به WAV برای موسیقی *همچنان* کارِ توست —
>    بندِ ۹ همان بخش. آنچه کنار رفت فقط ساختِ ویدئوست.)
