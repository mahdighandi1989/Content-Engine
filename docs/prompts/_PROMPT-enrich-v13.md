> نسخه: 13 — 2026-08-25
> برای نسخهٔ موتور: 5.97
> این فایل «بدنهٔ» دستورِ تسکِ غنی‌سازی است. تسک آن را از درایو می‌خواند.
> به‌روزرسانی = ساختنِ فایلِ تازه با شمارهٔ بالاتر (`_PROMPT-enrich-v14.md`).
...
>
> ۱. `audioFileId` را از درایو بگیر (فایلِ WAVِ «کامل»).
...
>
> ```
> ffmpeg -loop 1 -framerate 1 -i cover.png -i audio.wav \
...
> خودش می‌بندد)، نه فایلِ صوتی را، نه پوشهٔ دیگری را.
>
