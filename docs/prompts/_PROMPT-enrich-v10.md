> نسخه: 10 — 2026-08-24
> برای نسخهٔ موتور: 5.70
> این فایل «بدنهٔ» دستورِ تسکِ غنی‌سازی است. تسک آن را از درایو می‌خواند.
> به‌روزرسانی = ساختنِ فایلِ تازه با شمارهٔ بالاتر (`_PROMPT-enrich-v11.md`).
> هرگز این فایل را بازنویسی نکنید؛ تاریخچه باید بماند.
>
> تغییرِ نسخهٔ ۱۰ نسبت به ۹ — یک قاعدهٔ مطلق:
> در شناسنامهٔ ۲۳ اوت این جمله نوشته شده بود: «کانکتورِ درایو نمی‌تواند فایلِ
> صوتیِ چنددقیقه‌ای را بالا ببرد … کافی است همان را با همین نام در همین پوشه
> بگذارید.» صاحبِ برنامه جوابش را داد و درست هم گفت:
...
> هیچ شرایطی، از او نخواه فایلی را دستی جایی بگذارد — این خودش شکستِ همان
> اتوماسیونی است که ساخته شده.
