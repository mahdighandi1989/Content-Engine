> نسخه: 9 — 2026-08-23
> برای نسخهٔ موتور: 5.69
> این فایل «بدنهٔ» دستورِ تسکِ غنی‌سازی است. تسک آن را از درایو می‌خواند.
> به‌روزرسانی = ساختنِ فایلِ تازه با شمارهٔ بالاتر (`_PROMPT-enrich-v10.md`).
> هرگز این فایل را بازنویسی نکنید؛ تاریخچه باید بماند.
>
> تغییرِ نسخهٔ ۹ نسبت به ۸ — یک خرابیِ واقعی در همین کار:
> ۲۳ اوت دو فایلِ WAV درست ساخته شد (calm-study-lesson-intro و
> warm-slice-of-life-intro)، شناسنامه‌هایشان در پوشهٔ «موسیقی و افکت»
> نوشته شد — ولی **خودِ صدا فقط به گفت‌وگو پیوست شد و هرگز به درایو نرسید**.
> نتیجه: دو شناسنامه که می‌گویند قطعه‌ای هست، و نیست. موتور تا ۵٫۶۹ اصلاً
> نمی‌دیدشان چون پویش شناسنامه‌ها را رد می‌کرد.
> پیوست‌کردن به گفت‌وگو **تحویل نیست**. بخشِ ۹ حالا این را صریح می‌گوید و
> ترتیبِ درست را هم: اول فایل، بعد شناسنامه — هرگز برعکس.
