...
function selfUpdateDaily() {
  ...
  // و خانه‌داری دارد.
  /* ══ گویندهٔ تازه (بخشِ ۳۳) ══
     ارزان است: یک پیمایشِ پوشه، یک fetch از raw، یک فایلِ JSON. ولی پشتِ
     `nightHas_` می‌نشیند چون قاعدهٔ ۵٫۶۸ استثنا ندارد — هر چیزی که به
     شبانه اضافه شود پشتِ نگهبان می‌رود، وگرنه روزی همان است که نصب را
     گرسنه می‌گذارد. و **پیش از** کارهای سنگین، چون پاسخِ اکشن اگر امشب
     خوانده نشود، فردا شب دو برابر عقب است.

     ترتیبِ درونش هم عمدی است و در خودِ `vintNightly_` نوشته شده: اول
     برداشتنِ پاسخ، بعد نوشتنِ صف. */
