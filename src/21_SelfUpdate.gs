...
function selfUpdateDaily() {
  ...
  /* قسمتِ مرورِ بزرگ (۶٫۲۲، فراخوانِ رو به جلو ۲۱ ← ۳۰، پس در try).
     آخرِ همه و پشتِ یک بودجهٔ بزرگ: کارِ کمیابی است (یک بار برای هر مجموعه)
     و هیچ‌چیز به آن وابسته نیست، پس اگر امشب جا نشد فردا شب هست. جایش
     بالاتر از این یعنی گرفتنِ وقتِ کارهایی که هر شب لازم‌اند. */
