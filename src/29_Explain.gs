...
function explainPrompt_(ep, seriesName, budget, want) {
  ...
  L = L.concat([
    ...
    '',
    '۴) و مهم‌ترین بخشِ کارت: **دو مثالِ امروزی و ملموس** برای هر جا.',
    ...
    '(ت) یک جمله که می‌گوید این به چه دردِ شنونده می‌خورد. یعنی هر جا',
    'دستِ‌کم شش‌هفت جملهٔ واقعی — یک نفسِ کامل از یک آدمِ واقعی، نه یک',
    'تیکهٔ دوجمله‌ایِ رفعِ تکلیف.',
    '',
