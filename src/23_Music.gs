 ...
 * هر شب، نه فقط وقتی `musicFetch_`/`musicSeek_` چیزی برای نوشتن دارند.
 *
 * ══ چرا لازم شد ══
 ...
 * چند کلیدِ متفاوت در «گزارش‌های نظارت» تکرار شد. این تابع در خانه‌داریِ
 * ارزانِ هر شب (بی نگهبانِ بودجه) جاروی همان را انجام می‌دهد، جدا از
 * اینکه امشب فچ/سیکی هم اجرا شود یا نه.
 */
