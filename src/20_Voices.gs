...
var STYLE_PROBE_LINE =
  'شبی از شب‌های پاییز بود، از آن شب‌هایی که باد پشتِ پنجره می‌ایستد و ' +
  'نمی‌رود. مردی که سال‌ها از آن خانه دور مانده بود، کلید را در قفل ' +
  'چرخاند و ایستاد. هیچ‌چیز سرِ جایش نبود، و همه‌چیز همان‌جا بود.';
