...
function uiHandoutSeries(key) {
  try {
    ...
    /* رسیدِ ماندگار (قاعدهٔ ۶٫۵۱): پیام ۷۰۰ میلی‌ثانیه بعد با بازخوانی پاک
       می‌شود و این دقیقاً دکمه‌ای است که آدم می‌خواهد بداند اثر کرد یا نه. */
    boardReceipt_(true, 'به‌روزرسانیِ جزوه انجام شد', [msg]);
